/** Info (circled-i) glyph; renders an SVG <title> for a native hover tooltip. */
...
/** Sparkles glyph for the primary Format action. */
export function FormatIcon({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <path d="M19 14l.9 2.4 2.4.9-2.4.9-.9 2.4-.9-2.4-2.4-.9 2.4-.9L19 14z" />
    </svg>
  );
}
